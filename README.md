...
This project is a Ruby program that decode morse code.
...
- Decode morse code (only with letters).
...
```sh
  git clone https://github.com/blueberry1312/decode-morse.git
  cd decode-morse
```
...
- Add more ascii chars to the class.
